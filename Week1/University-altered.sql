...
—Determine the name of the constraint by double clicking on Enrolled in SQLDeveloper and finding the constraint under Constraint_Name;
—Drop the constraint
Alter table Enrolled
	drop constraint SYS_C001428818 
—Add the constraint with ‘on delete cascade’
Alter table Enrolled 
  add constraint SYS_C001428818  foreign key (StudentId) references Student(SID) on delete cascade
